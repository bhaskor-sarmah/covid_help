  ...
  var t = {
    ...
    changeState: function (e) {
      t.iterate (t.obj.breakpoints, function (e) {
        ...
        t.stateId), (t.stateId = e), (t.breakpointIds = t.stateId === t.sd
        ? []
        : t.stateId.substring (1).split (t.sd)), t.obj.states[t.stateId]
        ? (t.state = t.obj.states[t.stateId])
        : ((t.obj.states[t.stateId] = {attachments: []}), (t.state =
            t.obj.states[t.stateId]), t.iterate (
            t.stateHandlers,
            t.callStateHandler
          )), t.detachAll (t.state.attachments), t.attachAll (
        t.state.attachments
      ), (t.vars.stateId = t.stateId), (t.vars.state = t.state), t.trigger (
        'change'
      ), t.iterate (t.obj.breakpoints, function (e) {
    ...
    poll: function () {
      var e = '';
      (e = t.getStateId ()), '' === e && (e = t.sd), e !== t.stateId &&
        t.changeState (e);
    },
    _attach: null,
    attach: function (e) {
      ...
      return i.parentNode && i.parentNode.tagName
        ? !1
        : (t._attach || (t._attach = n.firstChild), n.insertBefore (
            i,
            t._attach.nextSibling
          ), e.permanent && (t._attach = i), !0);
    },
    attachAll: function (e) {
      var n = [];
      t.iterate (e, function (t) {
        n[e[t].priority] ||
          (n[e[t].priority] = []), n[e[t].priority].push (e[t]);
    ...
    init: function () {
      t.initMethods (), t.initVars (), t.initEvents (), (t.obj.head = document.getElementsByTagName (
        'head'
      )[0]), (t.isInit = !0), t.trigger ('init');
    },
    initEvents: function () {
      t.on ('resize', function () {
        ...
        t.on ('load', window.onload), (window.onload = function () {
        t.trigger ('load');
      }), window.onresize &&
        t.on ('resize', window.onresize), (window.onresize = function () {
        t.trigger ('resize');
        ...
        : function (t, e) {
            ...
            for (n in t)
              if (
                ...
                break;
          }), (t.matchesMedia = window.matchMedia
        ? function (t) {
            ...
            : window.getComputedStyle
                ? function (t) {
                    ...
                    var e = document.createElement ('style'),
                      ...
                      i = null;
                    (e.type = 'text/css'), (e.id =
                      'matchmediajs-test'), n.parentNode.insertBefore (
                      e,
                      n
                    ), (i =
                ...
                : function (t) {
                    ...
                    for (a in n)
                      (e = n[a]), '(' == e.charAt (0) &&
                        ((e = e.substring (1, e.length - 1)), (i = e.split (
                          /:\s+/
                        )), 2 == i.length &&
                          ((r[i[0].replace (/^\s+|\s+$/g, '')] = parseInt (
                            i[1]
                          )), (o = !0)));
                    if (!o) return !1;
    ...
    initVars: function () {
      ...
      (e = 'other'), (n = 0), (i = [
        ...
        return a.match (i[1])
          ...
          : void 0;
      }), (t.vars.browser = e), (t.vars.browserVersion = n), (e =
        'other'), (n = 0), (i = [
        [
          'ios',
          /([0-9_]+) like Mac OS X/,
        ...
        return a.match (i[1])
          ? ((e = i[0]), (n = parseFloat (
              i[2] ? i[2] (RegExp.$1) : RegExp.$1
            )), !1)
          : void 0;
      }), (t.vars.os = e), (t.vars.osVersion = n), (t.vars.IEVersion = 'ie' ==
        t.vars.browser
        ? t.vars.browserVersion
        : 99), (t.vars.touch = 'wp' == t.vars.os
        ? navigator.msMaxTouchPoints > 0
        : !!('ontouchstart' in window)), (t.vars.mobile =
        'wp' == t.vars.os ||
        'android' == t.vars.os ||
        'ios' == t.vars.os ||
        'bb' == t.vars.os);
...
!(function (t, e) {
  'function' == typeof define && define.amd
    ? define ([], e)
    : 'object' == typeof exports ? (module.exports = e ()) : (t.skel = e ());
}) (this, function () {
  return skel;
});
